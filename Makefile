...
SINDAN_FLUENTD_TAG       = sindan/fluentd:v1.6-1-rev1-rpi
SINDAN_VISUALIZATION_TAG = sindan/visualization:2.6.3-rpi
SINDAN_GRAFANA_TAG       = sindan/grafana:6.5.0-rev1-rpi
